...
async function getOrCreateCompany(companyData: any): Promise<number | null> {
...
async function mapApifyDataToLeads(apifyData: any[], collectionId: number, userId: number) {
  let created = 0;
  let skipped = 0;
  let errors = 0;
