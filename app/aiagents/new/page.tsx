      ...
      <SidebarInset className="flex h-dvh flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbLink asChild>
                    <Link href="/aiagents">Agents IA</Link>
                  </BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator className="hidden md:block" />
                <BreadcrumbItem>
                  <BreadcrumbPage>Nouvelle agent</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col gap-4 p-4 pt-6 overflow-hidden">
          <div className="flex shrink-0 flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold tracking-tight">Nouvelle agent IA</h1>
              <p className="text-muted-foreground mt-1">
                Créez un nouvel agent d&apos;intelligence artificielle.
              </p>
            </div>
          </div>
        </div>
